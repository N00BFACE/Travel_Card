...
<html lang="en">
    <head>
        ...
        <title>Transit Access Pass - Home Page</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{url('/')}}">Start T A P</a>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Travel Pass</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">A free, responsive, one tap travel card system.</h2>
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50"><a href="#!">bishal@travelpass.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card py-4 h-100">
                            <div class="card-body text-center">
                                ...
                                <hr class="my-4 mx-auto" />
                                <div class="small text-black-50">+977 9861301411</div>
                            </div>
                        </div>
                    </div>
                </div>
